...
def createPositionValueHash(pileupFilePath):
    #print "pileupFilePath=" + pileupFilePath
    positionValueHash = dict()
    if os.path.isfile(pileupFilePath):
        ...
        print "createPositionValueHash::Can't find file:" + pileupFilePath
...
while 1:
    ...
    positionValueHash = createPositionValueHash(pileupFile)
