...
def parse_argument_list(argv):
    ...
    subparser.add_argument("-m", "--mirror", dest="mirror", choices=["soft", "hard", "copy"],
        help="""
                Raw:Create a mirror copy of the reference directory
                and all the sample directories.  Use this option to
                avoid polluting the reference directory and sample
    ...
    subparser.add_argument("-c", "--conf", dest="configFile", type=str, metavar="FILE",
        help="""
                Raw:Relative or absolute path to a configuration file
                for overriding defaults and defining extra parameters
                for the tools and scripts within the pipeline.
    ...
    subparser.add_argument("-Q", "--queue_mgr", dest="jobQueueMgr", choices=["grid", "torque"],
