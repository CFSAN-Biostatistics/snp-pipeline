...
def parse_fastq_seqid_line(seqid_line):
    ...
    --------
    # Not Illumina format
    >>> parse_fastq_seqid_line("@SRR1206159_1/1") is None
    True

    # fastq-dump default settings
    >>> parse_fastq_seqid_line("@SRR498276.1 HWI-M00229:9:000000000-A1474:1:1:15012:1874 length=151")
    FastqSeqTags(instrument='M00229', flow_cell='A1474', lane='1')

    # trailing colon after lane
    >>> parse_fastq_seqid_line("@M00229:7:A0WG8:1:")
    ...
    >>> parse_fastq_seqid_line("@SRR498423_HWI-M00229:7:000000000-A0WG8:1:1:12203:2225/1")
    FastqSeqTags(instrument='M00229', flow_cell='A0WG8', lane='1')
...
def extract_fastq_metadata_tags(fastq_path):
...
def construct_fastq_read_group(fastq_path):
    ...
    """
    tags = extract_fastq_metadata_tags(fastq_path)
    if tags is None:
        return None
