...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', '--edge_length',  dest='edgeLength',    type=int, default=500, metavar='EDGE_LENGTH', help='The length of the edge regions in a contig, in which all SNPs will be removed. Default is 500.')
    ...
    parser.add_argument('-m', '--max_snp',  dest='maxSNP',  type=int, default=3, metavar='MAX_NUM_SNPs', help='The maximum number of SNPs allowed in a window. Default is 3.')
    parser.add_argument('-g', '--out_group',  dest='outGroupFile',  type=str, default="", metavar='OUT_GROUP', help='Relative or absolute path to the file indicating outgroup samples, one sample ID per line.')
