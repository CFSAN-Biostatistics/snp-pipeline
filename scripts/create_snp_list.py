...
if __name__ == '__main__':
    ...
    parser.add_argument(                   dest='filteredSampleDirsFile', type=str,                help='Relative or absolute path to the output file that will be created containing the filtered list of sample directories -- one per sample.  The samples in this file are those without an excessive number of snps.  See the --maxsnps parameter.')
    ...
    snppipeline.create_snp_list(args)
